...
https://minecraft.makecode.com/?liveforcelang=cy&ingame=1&ipc=1&noRunOnX=1&lockedEditor=1#tutorial:github:BlockBuilderJoe/edward-bell-makecode-prototype/edward-bell-play-v2
...
https://minecraft.makecode.com/?liveforcelang=cy&ingame=1&ipc=1&noRunOnX=1&lockedEditor=1#tutorial:github:BlockBuilderJoe/edward-bell-makecode-prototype/practice-bell-play-v2
...
https://github.com/BlockBuilderJoe/edward-bell-makecode-prototype/releases/download/v0.0.9/Quest-2C-Edwards-Bell-MakeCode-Prototype.mcworld

Version `v0.0.9` is a localisation-mechanism test build. The Welsh-locale world
...
opened MakeCode automatically, requested MakeCode's Welsh locale, and selected
the tutorial Markdown from `_locales/cy/`. This verifies the routing mechanism,
not the quality or completeness of any Welsh language content.
...
service. If a MakeCode control or Minecraft block remains in English, it is not
controlled by the Markdown in this repository. Add or review that string in
Crowdin, wait for it to be approved and published by MakeCode, then retest the
Welsh-locale link.
...
6. Test the English and `?liveforcelang=cy` links. Check every step, hint, block,
   and the green Play flow in Minecraft Education.
